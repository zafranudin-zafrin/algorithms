import {UnionFindEager} from './union-find-eager';

describe('Eager Union Spec', () => {
    let unionFind: UnionFindEager = new UnionFindEager(1e2);
    ...
    it('can union 5 and 7', () => {
        unionFind.union(5, 7);
        expect(unionFind.arr[1]).toStrictEqual(7);
        expect(unionFind.arr[5]).toStrictEqual(7);
    })

    it('can union 7 and 90', () => {
        unionFind.union(7, 90);
        expect(unionFind.arr[1]).toStrictEqual(90);
        expect(unionFind.arr[5]).toStrictEqual(90);
